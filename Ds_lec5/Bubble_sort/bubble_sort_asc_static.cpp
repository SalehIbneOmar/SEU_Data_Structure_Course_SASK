...
int main(){
    ...
    cout <<"Sorting Program Using Bubble Sort [ASC static]"<<endl;

    int arr[5] = {3, 2, 4, -2, -6};  // -10, -2, -1, 0, 1, 2, 5, 39, 41, 60
...
//============================= Algorithm part/Sorting part =============================
    ...
    cout <<endl;
    cout <<"After sorting in ascending order using bubble sort: "<<endl;
    //After Sorting Loop
